...
const PROSJEKTER_FALLBACK: Prosjekt[] = [
  ...
  { _id: 'fb-p04', tittel: 'Peis', bildeUrl: '/assets/galleri/ildsted/peis-3.jpg', rekkefolge: 4 },
  ...
  { _id: 'fb-p09', tittel: 'Skifer', bildeUrl: '/assets/galleri/muring/skifer-oppdal.jpg', rekkefolge: 9 },
