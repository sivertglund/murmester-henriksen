...
export default defineType({
  ...
  fields: [
    ...
    { name: 'medlemTekst', title: 'Medlems-tekst (i nederste linje)', type: 'string', initialValue: 'Medlem av Norske Murmestres Landsforening & Vestfold Murmesterlaug' },
    { name: 'facebookUrl', title: 'Facebook URL', type: 'url', initialValue: 'https://www.facebook.com/profile.php?id=61573745327073' },
